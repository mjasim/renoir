...
function populate_emo() {
    ...
    if (emotionColor === null) {
        document.getElementById("emoboxneutral").setAttribute("style", "background-color:#000000; color:#E9ECEF")
    }
    else {
        document.getElementById(selected_emo).innerHTML = "<h4>You selected the color of this ribbon for Neutral. To change it, select another color. To proceed, click Next.</h4>"
        document.getElementById("emoboxneutral").setAttribute("style", "background-color:" + emotionColor)
    }
...
function check_duplicate() {
    ...
    if (selected_color != "") {
        ...
        this_color = localStorage.getItem("neutral")
    }
...
function check_missing() {
    var current_fill = document.getElementById("emoboxneutral").getAttribute("style").slice(0, 24);
