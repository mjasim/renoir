...
function populate_emo() {
    ...
    if (emotionColor === null) {
        document.getElementById("emoboxaccept").setAttribute("style", "background-color:#000000")
    }
    else {
        document.getElementById(selected_emo).innerHTML = "<h4>You selected the color of this ribbon for Acceptance. To change it, select another color. To proceed, click Next.</h4>"
        document.getElementById("emoboxaccept").setAttribute("style", "background-color:" + emotionColor)
    }
    if (emotionColor == "#000001" || emotionColor == "#0000C8" || emotionColor == "#D40000" || emotionColor == "#5151FF" || emotionColor == "#009600" || emotionColor == "#008000") {
        ...
        document.getElementById("emoboxaccept").setAttribute("style", "background-color:#000000; color:#E9ECEF")
    }
    else {
...
function check_duplicate() {
    ...
    if(selected_color != ""){
        ...
        this_color = localStorage.getItem("accept")
    }

    console.log(this_color)

    if(this_color == localStorage.getItem("excited")){
    ...
    else if(this_color == localStorage.getItem("happy")){
        document.getElementById("survey_alert_bar").setAttribute("style", "visibility:visible");
    ...
    else if(this_color == localStorage.getItem("disapprove")){
        document.getElementById("survey_alert_bar").setAttribute("style", "visibility:visible");
    ...
    else if(this_color == localStorage.getItem("angry")){
        document.getElementById("survey_alert_bar").setAttribute("style", "visibility:visible");
        document.getElementById("survey_alert_bar").innerHTML = '<span class="pingIcon"><i class="fas fa-exclamation-circle fa-lg" style="color:crimson;margin-left:10px;">&nbsp;&nbsp;</i>' + "Duplicate with Anger. Please select a different color." + '</span>';
        str = "duplicate"
        logInteraction(str)
        return true
    }
...
function check_missing() {
    var current_fill = document.getElementById("emoboxaccept").getAttribute("style").slice(0, 24);
    console.log(current_fill)
...
//                 // localStorage.setItem("color_comment", value)
//                 console.log(localStorage)
//                 window.open('survey_confirmation.html', '_self')
//             }
//         }
//         else {
//             console.log("Errors")
