...
function populate_emo() {
    ...
    if (emotionColor === null) {
        document.getElementById("emoboxhappy").setAttribute("style", "background-color:#000000")
    }
    else {
        document.getElementById(selected_emo).innerHTML = "<h4>You selected the color of this ribbon for Happiness. To change it, select another color. To proceed, click Next.</h4>"
        document.getElementById("emoboxhappy").setAttribute("style", "background-color:" + emotionColor)
    }
    if (emotionColor == "#000001" || emotionColor == "#0000C8" || emotionColor == "#D40000" || emotionColor == "#5151FF" || emotionColor == "#009600" || emotionColor == "#008000") {
        ...
        document.getElementById("emoboxhappy").setAttribute("style", "background-color:#000000; color:#E9ECEF")
    }
    else {
...
function check_duplicate() {
    ...
    if(selected_color != ""){
        ...
        this_color = localStorage.getItem("happy")
    }
...
function check_missing() {
    var current_fill = document.getElementById("emoboxhappy").getAttribute("style").slice(0, 24);
    console.log(current_fill)
