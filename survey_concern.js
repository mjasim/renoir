...
function populate_emo() {
    ...
    if (emotionColor === null) {
        document.getElementById("emoboxconcerned").setAttribute("style", "background-color:#000000; color:#E9ECEF")
    }
    else {
        document.getElementById(selected_emo).innerHTML = "<h4>You selected the color of this ribbon for Concern. To change it, select another color. To proceed, click Next.</h4>"
        document.getElementById("emoboxconcerned").setAttribute("style", "background-color:" + emotionColor)
    }
...
function check_duplicate() {
    ...
    if (selected_color != "") {
        ...
        this_color = localStorage.getItem("concerned")
    }
...
function check_missing() {
    var current_fill = document.getElementById("emoboxconcerned").getAttribute("style").slice(0, 24);
